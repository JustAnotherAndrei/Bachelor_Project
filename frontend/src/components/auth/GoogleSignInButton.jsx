export default function GoogleSignInButton({ label = 'Continue with Google' }) {
  return (
    <a
      ...
      className="flex items-center justify-center gap-2 w-full px-4 py-2.5 bg-white hover:bg-gray-100 text-gray-900 rounded-lg font-medium text-sm transition-colors"
    >
